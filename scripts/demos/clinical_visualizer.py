...
UNET_CHECKPOINT_PATH = "/home/shared/model-weights/baseline-unet-both.ckpt"
CHECKPOINT_PATH = "/home/shared/model-weights/both.ckpt"
BASELINE_CHECKPOINT_PATH="/home/shared/model-weights/baseline-gan-both.ckpt"
...
parser.add_argument('--checkpoint_path', type=str, help='Model weights path', default=CHECKPOINT_PATH)
parser.add_argument('--baseline_checkpoint_path', type=str, help='Model weights path', default=BASELINE_CHECKPOINT_PATH)
parser.add_argument('--unet_checkpoint_path', type=str, help='Model weights path', default=UNET_CHECKPOINT_PATH)
